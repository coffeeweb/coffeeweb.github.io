...
<head>
	...
	<meta charset="utf-8">
	<title>CoffeeWeb | Serviços de Informática</title>
			...
			<div class="menu_block">
				...
				<div class="container clearfix">
					...
					<div class="logo pull-left">
						<a href="#" ><p><i class="fa fa-coffee"></i>Coffee<span class="b2">Web</span><small>Projeto, Gestão e Equipamentos‎.</small></p>
						</a>
					...
					<div id="search-form" class="pull-right">
						<form method="get" action="#">
							<input type="text" name="Search" value="Pesquisar" onFocus="if (this.value == 'Search') this.value = '';" onBlur="if (this.value == '') this.value = 'Search';" />
						</form>
					</div><!-- SEARCH FORM -->
					...
					<div class="pull-right">
						<nav class="navmenu center">
							<ul>
								...
								<!--<li class="scroll_btn"><a href="#projects" >Projetos</a></li>-->
								<!--<li class="scroll_btn"><a href="#team" >Team</a></li>-->
								<!--<li class="scroll_btn"><a href="#news" >Novidades</a></li>-->
				...
				<ul class="slides">
					<li class="slide1">
						<div class="flex_caption1">
							<p class="title1 captionDelay2 FromTop">#Websites</p>
							<p class="title2 captionDelay4 FromTop">Criativos</p>
							<p class="title4 captionDelay7 FromBottom">Websites modernos e bonitos,Todos com layout resposivo, Entre em contato com nossos desenvolvedores e conheça nosso serviço personalizado.</p>
						</div>
						<a class="slide_btn FromRight" href="javascript:void(0);" >Conheça-nos</a>
					<li class="slide2">
						<div class="flex_caption1">
					...
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-ss-12 margbot30">
							<a class="services_item" href="javascript:void(0);" >
								<p><b>Custo</b> Benefício</p>
								<span>Qualidade e modernidade com planos que cabe no seu bolso.</span>
							</a>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-ss-12 margbot30">
							<a class="services_item" href="javascript:void(0);" >
								<p><b>Design</b> Moderno</p>
								<span>Qualidade e Design unico ,temos tudo para construção de um site moderno.</span>
							</a>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-ss-12 margbot30">
							<a class="services_item" href="javascript:void(0);" >
								<p><b>Design</b> Responsivo</p>
								<span>Como belo design pronto para rodas em todos os seus dispositivos sejem eles, tablet , smartphone ou computador.</span>
							</a>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-ss-12 margbot30">
							<a class="services_item" href="javascript:void(0);" >
								<p><b>Atualizações</b>  & Suporte</p>
								<span>Stualizações frequentes e todo suporte que precisar.</span>
							</a>
						</div>
					</div><!-- //ROW -->
				</div><!-- //CONTAINER -->
				...
				<div class="container" data-appear-top-offset="-200" data-animated="fadeInUp">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade in active clearfix" id="tab1">
							<p class="title"><b>Código</b> Limpo</p>
							<span>Tenha seu website construído com qualidade e desempenho,
							Código que simplesmente “funciona” não é suficiente, infelizmente. Código que tem valor real e é duradouro, tem de ser “limpo”</span>
						</div>
						<div class="tab-pane fade clearfix" id="tab2">
							<p class="title"><b>Suporte</b> Técnico</p>
							<span>Com a CoffeeWeb, Você tem suporte agil e profissional, desde desktops à servidores.
							Visando sempre a necessidade do cliente. Agende um serviço conosco !</span>
						</div>
						...
						<div class="tab-pane fade clearfix" id="tab6">
							<p class="title"><b>Suporte ao cliente</b></p>
							<span>Além do suporte técnico presencial também oferecemos suporte a pelo contato.</span>
						</div>
					</div>
		...
		<div class="container">
			...
			<div class="row copyright">
				<div class="col-lg-12 text-center">
				 ...
				 <p>CoffeeWeb <i class="fa fa-coffee"></i>, &copy; <a href="" ><?php echo date('Y'); ?></a></p>
				</div>
